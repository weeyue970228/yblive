...
export default {
	...
	data() {
		return {
			livepushurl: 'rtmp://livepush.yunbaozb.com/live/23011_1625106084?txSecret=f91e1bbb27a4d65ab2072595e7061ceb&txTime=60dd50d4',
			currentWebview: null,
			itemTitle: '北京首安信息直播ssssssss录制测试点',
			begin: false,
			beauty:false,//0关，1开
	...
	methods: {
		...
		plusReady(currentWebview) {
			...
			//开始按钮
			var startBtn = new plus.nativeObj.View('startBtn', { top: '80%', left: '20%', height: '50px', width: '60%' }, [
				{
					tag: 'rect',
					id: 'startrect',
					position: {
